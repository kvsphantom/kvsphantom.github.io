...
var experience;
var seriousness;
var initTime,submitTime,duration;
...
function setUserData(){
	...
	sessionStorage.setItem("initTime",this.initTime);
...
function setVolumeAtL2(ref_vol){
	var l2=ref_vol*Math.pow(10,(30/20));
	return l2;
}

function setVolumeAtL3(ref_vol){
	var l3=ref_vol*Math.pow(10,(35/20));
	return l3;
}
...
function setSeriousnessDisplay(value){
	this.document.getElementById("seriousness").value = value;
}
...
function onSubmit(){
	...
	this.initTime = sessionStorage.getItem("initTime");
	...
	this.seriousness = this.document.getElementById("seriousness").value;
	this.submitTime = new Date().getTime() / 1000;
	this.duration = this.submitTime-this.initTime;
	...
	var data= 	{'date':new Date().toLocaleString(),
				...
				'seriousness':parseFloat(this.seriousness),
